...
class AlphaLatency:
    def __init__(self, alpha_latency):
        ...
        # self._base_inter_ring = self._base_inter.get("ring", None) if self._base_inter is not None else None
        # self._base_inter_tree = self._base_inter.get("tree", None) if self._base_inter is not None else None
        ...
        if self._base_tree is not None:
            try:
                ...
                raise TypeError("The base ring latency must be float.")
        # if self._base_inter_ring is not None:
        #     if isinstance(self._base_inter_ring, str):
        #         assert self._base_inter_ring in [LinkType.NET]
        #         self._base_inter_ring = LinkType[self._base_inter_ring ]
        #     else:
        #         try:
        #             self._base_inter_ring = float(self._base_inter_ring)
        #         except:
        #             raise TypeError("The base inter ring latency must be float.")
        # if self._base_inter_tree is not None:
        #     if isinstance(self._base_inter_tree, str):
        #         assert self._base_inter_tree in [LinkType.NET]
        #         self._base_inter_tree = LinkType[self._base_inter_tree]
        #     else:
        #         try:
        #             self._base_inter_tree = float(self._base_inter_tree)
        #         except:
        #             raise TypeError("The base inter tree latency must be float.")
    ...
    # @property
    # def base_inter_ring(self):
    #     return self._base_inter_ring

    # @property
    # def base_inter_tree(self):
    #     return self._base_inter_tree
