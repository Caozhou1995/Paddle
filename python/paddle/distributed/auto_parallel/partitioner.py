...
from .utils import print_program_with_dist_attr, is_forward_op, is_backward_op, is_loss_op, is_optimize_op, is_fillconst_op_for_micro_batch
...
class Partitioner(object):
    ...
    def partition_block(self, ref_block, target_block):
        ...
        for idx, op in enumerate(serial_ops):
            ...
            # partition op
            if is_forward_op(op) or op_dist_attr.is_recompute or is_fillconst_op_for_micro_batch(op):
